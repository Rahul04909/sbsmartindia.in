        ...
        <div class="charts-row">
            ...
            <div class="chart-card" style="grid-column: span 2;">
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="name" id="name" value="<?php echo htmlspecialchars($category['name']); ?>" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
                </div>

                <div class="form-group" style="margin-bottom: 20px;">
                    <label style="display: block; margin-bottom: 8px; font-weight: 500;">Slug <span style="color: red;">*</span></label>
                    <input type="text" name="slug" id="slug" value="<?php echo htmlspecialchars($category['slug']); ?>" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; background: #f9f9f9;">
                    <small style="color: #666;">Auto-generated from name</small>
                </div>

                <div class="form-group" style="margin-bottom: 20px;">
                    <label style="display: block; margin-bottom: 8px; font-weight: 500;">Description</label>
                    <textarea name="description" id="summernote"><?php echo htmlspecialchars($category['description']); ?></textarea>
                </div>
            </div>
            ...
            <div class="chart-card">
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                    ...
                    <?php if (!empty($category['image'])): ?>
                        <div style="margin-bottom: 10px;">
                            <img src="../../<?php echo htmlspecialchars($category['image']); ?>" alt="Current Image" style="max-width: 100%; height: auto; border-radius: 4px; border: 1px solid #ddd;">
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="meta_title" value="<?php echo htmlspecialchars($category['meta_title']); ?>" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
                </div>

                <div class="form-group" style="margin-bottom: 20px;">
                    <label style="display: block; margin-bottom: 8px; font-weight: 500;">Meta Description</label>
                    <textarea name="meta_description" rows="3" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; resize: vertical;"><?php echo htmlspecialchars($category['meta_description']); ?></textarea>
                </div>

                <div class="form-group" style="margin-bottom: 20px;">
                    <label style="display: block; margin-bottom: 8px; font-weight: 500;">Meta Keywords</label>
                    <input type="text" name="meta_keywords" value="<?php echo htmlspecialchars($category['meta_keywords']); ?>" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
                </div>

                <button type="submit" class="btn-admin" style="padding: 12px 24px; width: 100%;">
...
$(document).ready(function() {
    ...
    // Slug Generator (only if name changes)
