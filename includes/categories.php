                    ...
                    while($brand = $brand_result->fetch_assoc()) {
                        ...
                        if ($cat_result->num_rows > 0) {
                            ...
                            <div class="brand-card">
                                ...
                                <a href="brand.php?id=<?php echo $brand_id; ?>&type=brand" class="see-all-brand">See all <?php echo htmlspecialchars($brand_name); ?> <i class="fa-solid fa-chevron-right" style="font-size: 10px; margin-left: 5px;"></i></a>
                            </div>
                            <?php
                        }
                    }
