            ...
            <?php if (count($cart_items) > 0): ?>
                <?php foreach ($cart_items as $item): ?>
                    <div class="cart-item" id="item-<?php echo $item['cart_id']; ?>">
                        <img src="<?php echo !empty($item['featured_image']) ? htmlspecialchars($item['featured_image']) : 'assets/images/no-image.png'; ?>"
                            class="cart-img">
            ...
            <?php else: ?>
                <div class="empty-cart">
                    ...
                    <a href="index.php" class="btn-primary"
                        style="display:inline-block; margin-top:20px; text-decoration:underline;">Shop Now</a>
                </div>
            <?php endif; ?>
        </div>
