...
<div class="shop-header-section">
    <div class="container">
        ...
        <div class="breadcrumbs">
            <a href="index.php">Home</a> &gt; <a href="products.php">Shop</a> &gt; <span><?php echo htmlspecialchars($filter_name); ?></span>
        </div>
    </div>
</div>
        ...
        <div class="filter-header-content">
            ...
            <div style="text-align: center; border-top: 1px solid #eee; padding-top: 30px;">
                ...
                <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 20px; margin-bottom: 25px;">
                    <a href="mailto:marcom.sbsyscon@gmail.com" class="btn-view" style="padding: 12px 25px; background: #333; color: #fff; width: auto;">
                        <i class="fas fa-envelope" style="margin-right: 8px;"></i> marcom.sbsyscon@gmail.com
                    </a>
                    <a href="tel:+917506943307" class="btn-view" style="padding: 12px 25px; background: #004aad; color: #fff; width: auto;">
    ...
    <div class="shop-content" style="width: 100%;">
        <div class="shop-top-bar">
            <div class="results-count">
                Showing <strong><?php echo $total_products > 0 ? $offset + 1 : 0; ?>-<?php echo min($offset + $limit, $total_products); ?></strong> of <strong><?php echo $total_products; ?></strong> products in <?php echo htmlspecialchars($filter_name); ?>
            </div>
        </div>
            ...
            <?php else: ?>
                <div class="no-products-found">
                    ...
                    <div style="margin-top: 20px;">
                        <a href="products.php" class="btn-view" style="width: auto; display: inline-block; padding: 10px 20px;">Browse All Products</a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
