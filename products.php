...
try {
    ...
    if (!$brands_res)
        throw new Exception("Brands Query Failed: " . $conn->error);
                ...
                <div class="filter-group">
                    ...
                    <div class="filter-content categories-list">
                        <ul>
                            <li>
                                <a href="products.php"
                                    class="<?php echo !isset($_GET['category']) && !isset($_GET['sub_category']) ? 'active' : ''; ?>">All
                                    Categories</a>
                            </li>
                                ...
                                <li class="has-sub">
                                    <div class="cat-link-wrap">
                                        <a href="products.php?category=<?php echo $cat['id']; ?>"
                                            class="<?php echo (isset($_GET['category']) && $_GET['category'] == $cat['id']) ? 'active' : ''; ?>">
                                    ...
                                    <?php if (!empty($cat['sub_categories'])): ?>
                                        <ul class="sub-cat-list"
                                            style="<?php echo (isset($_GET['category']) && $_GET['category'] == $cat['id']) ? 'display:block' : ''; ?>">
                                            <?php foreach ($cat['sub_categories'] as $sub): ?>
                                                <li>
                                                    <a href="products.php?sub_category=<?php echo $sub['id']; ?>"
                                                        class="<?php echo (isset($_GET['sub_category']) && $_GET['sub_category'] == $sub['id']) ? 'active' : ''; ?>">
        ...
        <div class="shop-content">
            ...
            <div class="shop-top-bar">
                <div class="results-count">
                    ...
                    of <strong><?php echo $total_products; ?></strong> results
                </div>
                <div class="sort-options">
                    <form id="sortForm" method="GET">
                        ...
                        <select name="sort" onchange="document.getElementById('sortForm').submit()">
                            <option value="newest" <?php echo $sort_option == 'newest' ? 'selected' : ''; ?>>Newest First
                            </option>
                            ...
                            <option value="name_asc" <?php echo $sort_option == 'name_asc' ? 'selected' : ''; ?>>Name: A-Z
                            </option>
                        </select>
                    </form>
                </div>
            ...
            if ($show_flender_content):
                ...
                <div class="filter-header-content" style="margin-top: 20px;">
                    <div style="text-align: center; margin-bottom: 30px;">
                        <h2 style="font-weight: 700; color: #333; margin-bottom: 15px;">Flender – Engineered Drive
                            Technology</h2>
                    ...
                    <div style="font-size: 1.1rem; line-height: 1.7; color: #555; margin-bottom: 30px;">
                        <p style="margin-bottom: 20px;">
                            Flender is a global leader in mechanical and electrical drive technology, known worldwide for
                            its highly reliable, efficient, and application-engineered gearbox solutions. With decades of
                            engineering excellence, Flender products are designed to perform in the most demanding
                            industrial environments across sectors such as cement, steel, power, mining, oil & gas, material
                            handling, and infrastructure.
                        </p>
                        <p style="margin-bottom: 20px;">
                            <strong>Flender gearboxes are not standard off-the-shelf products.</strong>
                            They are application-specific solutions, engineered based on load conditions, duty cycles,
                            mounting positions, environmental factors, and lifecycle expectations — ensuring maximum uptime,
                    ...
                    <div
                        ...
                        <h3 style="font-size: 1.2rem; font-weight: 700; margin-bottom: 10px; color: #333;"><i
                                class="fas fa-check-circle" style="color: #004aad; margin-right: 10px;"></i>Authorized
                            Partner</h3>
                        <p style="margin: 0; color: #444;">
                            <strong>S.B. Syscon Pvt. Ltd.</strong> is an Authorized Partner for Flender Gearboxes.
                            All Flender solutions offered through SBS are designed and validated with direct support from
                            the Flender backend technical team, ensuring correct selection, compliance with application
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p style="margin: 0; color: #856404;">
                                Due to the engineering-driven nature of Flender products, we require detailed technical
                                inputs before recommending or quoting a solution. Hence, Flender enquiries are handled
                                through Assisted Support rather than direct online checkout.
                            </p>
                        </div>
                    </div>
                    ...
                    <div style="text-align: center; border-top: 1px solid #eee; padding-top: 30px;">
                        ...
                        <div
                            style="display: flex; justify-content: center; flex-wrap: wrap; gap: 20px; margin-bottom: 25px;">
                            <a href="mailto:marcom.sbsyscon@gmail.com" class="btn-view"
                                style="padding: 12px 25px; background: #333; color: #fff; width: auto; display: inline-block;">
                                <i class="fas fa-envelope" style="margin-right: 8px;"></i> info@sbsyscon.in
                            </a>
                            <a href="tel:+917506943307" class="btn-view"
                                style="padding: 12px 25px; background: #004aad; color: #fff; width: auto; display: inline-block;">
                                <i class="fas fa-phone" style="margin-right: 8px;"></i> +91 98995-98955
                            </a>
                        </div>
                        <p style="color: #777; font-size: 0.9rem;">Our team will work closely with Flender’s technical
                            experts to study your application and deliver the most optimized, reliable, and future-ready
                            drive solution.</p>
                    </div>
                </div>
            <?php endif; ?>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-price">
                                    <?php if ($prod['sales_price'] > 0): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <button type="button" class="btn-request-price"
                                            onclick="openQuoteModal(<?php echo $prod['id']; ?>, '<?php echo addslashes($prod['title']); ?>')">Request
                                            Price</button>
                                    <?php endif; ?>
                                </div>
